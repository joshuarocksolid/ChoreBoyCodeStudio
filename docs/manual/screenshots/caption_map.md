# Screenshot Caption Map

- `manual_01_main_window.png` — Main window after launch.
- `manual_02_new_project_dialog.png` — New Project dialog with template options.
- `manual_03_run_log_success.png` — Run Log with successful output.
- `manual_04_interface_tour.png` — Numbered overview of the editor layout.
- `manual_05_open_project.png` — Open Project flow.
