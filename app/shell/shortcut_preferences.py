...
SHORTCUT_COMMANDS: tuple[ShortcutCommand, ...] = (
    ...
    ShortcutCommand("shell.action.edit.cut", "Cut", "Ctrl+X", "Edit"),
    ShortcutCommand("shell.action.edit.copy", "Copy", "Ctrl+C", "Edit"),
    ShortcutCommand("shell.action.edit.paste", "Paste", "Ctrl+V", "Edit"),
    ...
    ShortcutCommand("designer.layout.align_left", "Align Left", "", "Layout"),
    ShortcutCommand("designer.layout.align_hcenter", "Align Horizontal Centers", "", "Layout"),
    ShortcutCommand("designer.layout.align_right", "Align Right", "", "Layout"),
    ShortcutCommand("designer.layout.align_top", "Align Top", "", "Layout"),
    ShortcutCommand("designer.layout.align_vcenter", "Align Vertical Centers", "", "Layout"),
    ShortcutCommand("designer.layout.align_bottom", "Align Bottom", "", "Layout"),
    ShortcutCommand("designer.layout.distribute_horizontal", "Distribute Horizontally", "", "Layout"),
    ShortcutCommand("designer.layout.distribute_vertical", "Distribute Vertically", "", "Layout"),
    ShortcutCommand("designer.layout.adjust_size", "Adjust Size", "Ctrl+J", "Layout"),
    ShortcutCommand("designer.form.preview", "Preview Form", "Ctrl+R", "Form"),
    ShortcutCommand("designer.form.preview.default", "Preview Variant: Default", "", "Form"),
    ShortcutCommand("designer.form.preview.fusion", "Preview Variant: Fusion Style", "", "Form"),
    ShortcutCommand(
        "designer.form.preview.phone_portrait",
        "Preview Variant: Phone Portrait",
        "",
        "Form",
    ),
    ShortcutCommand(
        "designer.form.preview.tablet_portrait",
        "Preview Variant: Tablet Portrait",
        "",
        "Form",
    ),
