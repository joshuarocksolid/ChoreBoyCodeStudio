...
def build_main_window_menus(
    ...
    *,
    ...
    callbacks = MenuCallbacks(
        ...
        on_stop=window._run_debug_presenter.user_stop_session,
        ...
        on_toggle_comment=window._editor_tabs_coordinator.handle_toggle_comment_action,
        on_indent=window._editor_tabs_coordinator.handle_indent_action,
        on_outdent=window._editor_tabs_coordinator.handle_outdent_action,
        on_paste_reindented_flat_python=window._editor_tabs_coordinator.handle_paste_reindented_flat_python_action,
        on_reindent_flat_python_selection=window._editor_tabs_coordinator.handle_reindent_flat_python_selection_action,
        ...
        on_set_language_mode=window._editor_tabs_coordinator.handle_set_language_mode_action,
        on_clear_language_override=window._editor_tabs_coordinator.handle_clear_language_override_action,
        on_inspect_token=window._editor_tabs_coordinator.handle_inspect_token_action,
