"""Stylesheet section builders grouped by shell UI area."""
...
from app.shell.style_sheet_sections_workspace import (
...
from app.shell.style_sheet_sections_panels import (
    shell_section_problems_panel,
    shell_section_outline_panel,
