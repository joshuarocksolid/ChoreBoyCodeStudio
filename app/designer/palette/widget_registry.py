...
def default_widget_palette_registry() -> WidgetPaletteRegistry:
    ...
    definitions = [
        ...
        PaletteWidgetDefinition("QListWidget", "List Widget", "Item Views", "listWidget", icon_char="\u2261"),
        PaletteWidgetDefinition("QTreeWidget", "Tree Widget", "Item Views", "treeWidget", icon_char="\u22EE"),
        PaletteWidgetDefinition("QTableWidget", "Table Widget", "Item Views", "tableWidget", icon_char="\u2637"),
        ...
        PaletteWidgetDefinition("QStackedWidget", "Stacked Widget", "Containers", "stackedWidget", icon_char="\u25A4"),
        PaletteWidgetDefinition("QSplitter", "Splitter", "Containers", "splitter", icon_char="\u2225"),
        PaletteWidgetDefinition("QMainWindow", "Main Window", "Containers", "mainWindow", icon_char="\u25A3"),
